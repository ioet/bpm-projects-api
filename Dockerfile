...
RUN wget -O opa https://github.com/open-policy-agent/opa/releases/download/v0.9.2/opa_linux_amd64
RUN chmod 755 ./opa
RUN wget -o $(curl "https://api.github.com/repos/ioet/bpm-opa/releases/latest" | jq -r '.assets[0].browser_download_url')
